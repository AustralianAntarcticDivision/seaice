...
If you want more direct access to the entire sea ice data set [read this blog post](https://ropensci.org/blog/2018/11/13/antarctic/). 

## Work in progress

If you aren't comfortable installing the development version of [vapour](https://github.com/hypertidy/vapour.git) (instructions are given by the example function), then please don't actually try to run the example. You can explore the sources and temporary files created by the functions in this package, they are 
...
- put the scaling and missing value setting in the VRT (currently use of these by raster/stars/terra will get the original byte values)
